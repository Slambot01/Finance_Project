...
type FinancialRecord struct {
	...
	UserID    uuid.UUID       `gorm:"type:uuid;not null;index:idx_records_user_type_date" json:"user_id"`
	...
	Type      RecordType     `gorm:"type:varchar(20);not null;index:idx_records_user_type_date" json:"type"`
	Category  string         `gorm:"type:varchar(100);not null" json:"category"`
	Date      time.Time      `gorm:"not null;index:idx_records_user_type_date" json:"date"`
